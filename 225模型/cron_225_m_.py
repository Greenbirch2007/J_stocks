...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "JS_Mons225")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    title = 'JS_Mons225'  # 邮件主题
    content = 'JS_Mons225'  # 邮件内容
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/JS_Mons225.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='JS_Mons225.xlsx')
